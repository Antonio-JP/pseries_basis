...
# documentation.
html_theme_options = {
    # "repository_url": "https://github.com/Antonio-JP/pseries_basis",
    # "repository_branch": "master",
    # "path_to_docs": "https://antonio-jp.github.io/pseries_basis/",
}
...
html_short_title = "pseries_basis"
...
# We use MathJax to build the documentation unless the environment# variable SAGE_DOC_MATHJAX is set to "no" or "False".  (Note that if
